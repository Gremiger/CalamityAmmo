...

{
    public class ChewingGum : ModItem
    {
        public override void SetStaticDefaults()
        {
			...
			//DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "Focus Chewing Gum");
            ...
            //Tooltip.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "Increases view range for guns (right-click to zoom out)\n" +
                "When holding a gun-type weapon, displays an aiming line and replaces the cursor with a crosshair");*/
		}
