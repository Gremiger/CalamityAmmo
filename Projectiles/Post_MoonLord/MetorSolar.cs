...
namespace CalamityAmmo.Projectiles.Post_MoonLord
{
	public class MetorSolar : ModProjectile
	{
		...
		public override void OnKill(int timeLeft)
		{
			...
			base.Projectile.position.X = base.Projectile.position.X + base.Projectile.width / 2;
			base.Projectile.position.Y = base.Projectile.position.Y + base.Projectile.height / 2;
			...
			if (Main.netMode != 2)
			{
				...
				{
					int num340 = Gore.NewGore(base.Projectile.GetSource_Death(null), base.Projectile.position + new Vector2(base.Projectile.width * Main.rand.Next(100) / 100f, base.Projectile.height * Main.rand.Next(100) / 100f) - Vector2.One * 10f, default(Vector2), Main.rand.Next(61, 64), 1f);
			...
			for (int num341 = 0; num341 < 5; num341++)
			{
				...
				int num343 = Dust.NewDust(base.Projectile.position, base.Projectile.width, base.Projectile.height, num342, 2.5f * Projectile.direction, -2.5f, 0, new Color(255, Main.DiscoG, 0), 1f);
