...
namespace CalamityAmmo.Ammos.Hardmode
{
    public class WeakAstralArrow : ModItem
    {
        public override void SetStaticDefaults()
        {
            ...
            //DisplayName.AddTranslation(GameCulture.FromCultureName(GameCulture.CultureName.Chinese), "Dust Star Arrow");
            // Tooltip.SetDefault(IsChinese() ? "The worm said, \"Yes, I have many fathers.\"" : "The worm said, \"Yes, I have many fathers.\"");
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(ModContent.ItemType< StarblightSoot > (), 1);
